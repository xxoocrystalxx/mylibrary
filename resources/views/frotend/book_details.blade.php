            ...
            <div class="col-sm vertical-bar">
                <div class="booklist-container">
                    ...
                    <button type="button" class="btn btn-outline-secondary btn-rounded waves-effect" data-bs-toggle="modal"
                        data-bs-target="#AddLibraryModal">
                        @if ($list)
        ...
        <div class="col-sm-9 horizontal-bar">
            ...
            <div class="rating-star">
                <input type="hidden" class="rating" data-filled="mdi mdi-heart text-danger"
                    data-empty="mdi mdi-heart-outline text-danger" value="{{ $book->rating() }}" disabled="disabled" />
                        ...
                        <div class="form-group mb-3 row">
                            <div class="col-12">
                                <input type="radio" class="btn-check" name="status" id="option1"
                                    value="Want to read" autocomplete="off" checked>
