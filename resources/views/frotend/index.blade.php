...
@section('title')
    Home | One piece Website
@endsection

<!-- banner-area -->
@include('frotend.home_all.home_slide')
<!-- banner-area-end -->

<!-- about-area -->
@include('frotend.home_all.home_about')
<!-- about-area-end -->
...
<!-- portfolio-area -->
@include('frotend.home_all.portfolio')
<!-- portfolio-area-end -->
...
<!-- blog-area -->
@include('frotend.home_all.home_blog')
<!-- blog-area-end -->
