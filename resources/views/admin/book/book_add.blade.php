        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            <h4 class="card-title">Add Book Page</h4>
                            <form method="POST" action="{{ route('store.book') }}" enctype="multipart/form-data"
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                        <select class="form-select select2" aria-label="Default select example"
                                            ...
                                            <option selected disabled value="">Select Author or Insert new Author
                                            </option>
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                        <select class="select2 form-control select2-multiple" multiple="multiple"
                                            data-placeholder="Select genre o insert new genre" name="genres[]" required>
                                ...
                                <input type="submit" value="Insert Book" class="btn btn-info waves-effect waves-light">
                            </form>
                        </div>
                    </div>
                </div> <!-- end col -->
