                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                        <input class="form-control" id="example-text-input" name="title" type="text"
                                            value="{{ $homeslide ? $homeslide->title : '' }}">
                                    </div>
                                </div>
                                <!-- end row -->
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                        <input class="form-control" id="short_title" name="short_title" type="text"
                                            value="{{ $homeslide ? $homeslide->short_title : '' }}">
                                    </div>
                                </div>
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                        <input class="form-control" id="video_url" name="video_url" type="text"
                                            value="{{ $homeslide ? $homeslide->video_url : '' }}">
                                    </div>
                                </div>
                                <!-- end row -->
                                <div class="row mb-3">
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                        <img id="showImage" class="rounded avatar-lg"
                                            src="{{ $homeslide || empty($homeslide->home_slide) ? url('upload/no_image.jpg') : url($homeslide->home_slide) }}"
                                            alt="Card image cap">
                                    </div>
                                </div>
                                <!-- end row -->
